...
from pycaching.tile import Tile
...
class Geocaching(object):
    ...
    #         new_zoom = self._get_zoom_by_distance(precision, area.mean_point.latitude, Tile.size, "ge")
    #         new_precision = area.mean_point.precision_from_tile_zoom(new_zoom, Tile.size)
    #         assert precision >= new_precision
    #         new_zoom = min(new_zoom, Tile.max_zoom)
    #
    ...
    #     starting_precision = starting_tile_width / Tile.size
    #     assert dist <= starting_tile_width
    #     zoom = min(starting_zoom, Tile.max_zoom)
    ...
    #             # border of the Tile. Throw additional ones away.
