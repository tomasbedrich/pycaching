...
class Cache(object):
    ...
    def __init__(self, geocaching, wp, **kwargs):
        ...
        :param geocaching: Reference to :class:`.Geocaching` instance, used for loading cache data.
        :param wp: Cache waypoint, eg. "GC1PAR2".
    ...
    def wp(self, wp):
        ...
        :param wp: Waypoint string, must start with "GC".
        """
    ...
    @property
    def geocaching(self):
        """Return a reference to used :class:`.Geocaching` class."""
        return self._geocaching

    @geocaching.setter
    def geocaching(self, geocaching):
        """Set a reference to :class:`.Geocaching` class.

        :param geocaching: Geocaching instance, must have :method:`.Geocaching._request` method.
        """
    ...
    def location(self, location):
        ...
        :param location: Location has to be either `str` or :class:`.Point`. If location is `str`,
            then :method:`.Point.from_string` is called on it.
        """
    ...
    def type(self, type):
        ...
        :param type: One of :class:`.cache.Type` or `str`. Then :method:`.cache.Type.from_string`
            is called on that `str`.
        """
